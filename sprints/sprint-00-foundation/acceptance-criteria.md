...
All criteria below are mandatory unless the Human Architect records an explicit exception and risk acceptance.

- [ ] Product Vision approved — S00-001
- [ ] AGENTS.md approved — S00-002
- [ ] Architecture specification approved — S00-003
- [ ] Security specification approved — S00-004
...
- [ ] Human Architect performs and records final sprint review
- [ ] Human Architect records sprint closure, including merge reference and accepted exceptions

An evidence item MAY be marked `N/A` only with a reason and only when governance permits it; mandatory approvals and Human Architect gates cannot be `N/A`.
